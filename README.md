...
Each issue page has inline CSS, inline SVG flags and logo, and Archivo from Google Fonts. The site has no build step on the host. `scripts/build.py` runs locally and its output is committed.
